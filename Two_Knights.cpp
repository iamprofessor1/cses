...
void solve()
{
    ...
    f1E(t)
    {
        ll n = i;
        // cin >> n;
        // total no.of ways to place two knights n*nC2
        ll total_no_of_ways = n * n * 1LL * (n * n - 1LL) / 2;
        ll position_of_attacting = 8LL * (n - 1) * (n - 2) / 2;
        ll not_attacting = total_no_of_ways - position_of_attacting;
        cout << not_attacting << ln;
    }
}
